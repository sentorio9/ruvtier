  ...
  return (
    <div className="relative">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-6 py-16 md:py-24 luxury-container">
        {/* Women */}
        <ScrollFadeIn>
          <Link to="/boutique/women" className="group relative block pb-36 md:pb-40 focus:outline-none">
            <div className="relative w-full aspect-[3/4] overflow-hidden bg-secondary transition-shadow duration-[800ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:shadow-[0_30px_70px_-32px_rgba(0,0,0,0.28)] group-focus-visible:shadow-[0_30px_70px_-32px_rgba(0,0,0,0.28)]">
              <img
                src={womenImage}
                alt="Women's collection by RUVTIER"
                className="w-full h-full object-cover object-[center_25%] transition-[transform,filter] duration-[1100ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:scale-[1.015] group-hover:brightness-[0.98] group-focus-visible:scale-[1.015] group-focus-visible:brightness-[0.98]"
                loading="lazy"
              />
            </div>
            <div className="absolute left-1/2 top-full z-10 flex w-[calc(100%-3rem)] max-w-[460px] -translate-x-1/2 flex-col items-center bg-background px-6 py-5 md:py-6 text-center text-foreground shadow-none will-change-transform transition-[transform,box-shadow] duration-[850ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] motion-safe:group-hover:-translate-y-[60%] motion-safe:group-focus-visible:-translate-y-[60%] motion-safe:group-hover:shadow-[0_18px_55px_-38px_rgba(0,0,0,0.45)] motion-safe:group-focus-visible:shadow-[0_18px_55px_-38px_rgba(0,0,0,0.45)]">
              ...
              <Editable kind="text_block" contentKey="home_women_card" field="blurb" label="Women — blurb" as="p" className="type-body max-w-[340px] mb-5">
                {womenBlurb}
              </Editable>
              <span className="inline-flex items-center gap-2 type-cta">
                <span className="relative inline-block pb-1">
                  ...
                  <span
                    aria-hidden
                    className="absolute left-0 right-0 -bottom-px h-px bg-current origin-left scale-x-0 group-hover:scale-x-100 group-focus-visible:scale-x-100 transition-transform duration-[700ms] ease-[cubic-bezier(0.22,0.61,0.36,1)]"
                  />
                </span>
                <svg className="w-3 h-3 transition-transform duration-500 group-hover:translate-x-1 group-focus-visible:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3" /></svg>
              </span>
            </div>
          </Link>
        </ScrollFadeIn>
        ...
        {/* Men */}
        <ScrollFadeIn delay={0.1}>
          <Link to="/boutique/men" className="group relative block pb-36 md:pb-40 focus:outline-none">
            <div className="relative w-full aspect-[3/4] overflow-hidden bg-secondary flex items-center justify-center transition-shadow duration-[800ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:shadow-[0_30px_70px_-32px_rgba(0,0,0,0.28)] group-focus-visible:shadow-[0_30px_70px_-32px_rgba(0,0,0,0.28)]">
              <img
                src={menImage}
                alt="Men's collection by RUVTIER"
                className="w-full h-full object-contain object-center transition-[transform,filter] duration-[1100ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:scale-[1.015] group-hover:brightness-[0.98] group-focus-visible:scale-[1.015] group-focus-visible:brightness-[0.98]"
                loading="lazy"
              />
            </div>
            <div className="absolute left-1/2 top-full z-10 flex w-[calc(100%-3rem)] max-w-[460px] -translate-x-1/2 flex-col items-center bg-background px-6 py-5 md:py-6 text-center text-foreground shadow-none will-change-transform transition-[transform,box-shadow] duration-[850ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] motion-safe:group-hover:-translate-y-[60%] motion-safe:group-focus-visible:-translate-y-[60%] motion-safe:group-hover:shadow-[0_18px_55px_-38px_rgba(0,0,0,0.45)] motion-safe:group-focus-visible:shadow-[0_18px_55px_-38px_rgba(0,0,0,0.45)]">
              ...
              <Editable kind="text_block" contentKey="home_men_card" field="blurb" label="Men — blurb" as="p" className="type-body max-w-[340px] mb-5">
                {menBlurb}
              </Editable>
              <span className="inline-flex items-center gap-2 type-cta">
                <span className="relative inline-block pb-1">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-8 lg:gap-10 items-start">
            {[
              ...
              <ScrollFadeIn key={item.label} delay={i * 0.08}>
                <Link
                  to={item.to}
                  className="group relative block pb-24 md:pb-28 focus:outline-none"
                >
                  <div className="relative flex w-full aspect-[4/5] items-center justify-center overflow-hidden bg-background px-[10%] py-[10%] transition-shadow duration-[850ms] ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:shadow-[0_24px_60px_-38px_rgba(0,0,0,0.28)] group-focus-visible:shadow-[0_24px_60px_-38px_rgba(0,0,0,0.28)]">
                    <img
                      src={item.img}
                      alt={item.label}
                      loading="lazy"
