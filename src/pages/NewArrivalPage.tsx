 ...
 *
 * A curated destination for the house's newest and featured pieces,
 * surfaced as a quiet editorial grid.
 */
...
const NewArrivalPage = () => {
  ...
  const { data: products, isLoading } = useActiveProducts({ featured: true });
  usePageMeta({
    title: "New Arrival",
    description: "The latest pieces composed by the house, available now or by quiet allocation.",
  });
  usePriceTick();
        ...
        <div className="luxury-container text-center">
          <ScrollFadeIn>
            <div className="hero-glow inline-block">
              <h1 className="hero-title luxury-heading mb-4">New arrival</h1>
            </div>
          </ScrollFadeIn>
          <ScrollFadeIn delay={0.15}>
            <p className="luxury-body mx-auto text-center">
              The most recent pieces to emerge from the atelier.
            </p>
          </ScrollFadeIn>
        </div>
      </section>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-24">
              <p className="type-body text-muted-foreground">
                New pieces are being composed. Please return soon.
              </p>
            </div>
          )}
        </div>
